...
On the home screen, the child now has the option to play the game!
...
Once the correct scripture is chosen, it is then the child's scripture for the week! The child has the ability to save this scripture to their dashboard. At the end of the week, they can also mark the scripture as complete.

![Scripture](images/scripture.png)
